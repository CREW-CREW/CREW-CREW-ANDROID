...
public class TempRunningCrewInfoList extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alert.setTitle("새로운 크루 만들기");
        alert.setMessage("새로운 크루의 정보를 입력하시오.");
        ...
        makeCrewBtn.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
                View inflator = linf.inflate(R.layout.makecrew_dialog, null);

                makeCrewName = (EditText) inflator.findViewById(R.id.makeCrewName);
                makeCrewLevel = (EditText) inflator.findViewById(R.id.makeCrewLevel);
                makeCrewNum = (EditText) inflator.findViewById(R.id.makeMaxNumber);
                makeCrewTime = (EditText) inflator.findViewById(R.id.makeCrewTime);
    ...
    private void sendObject(){
        ...
        try{
            jsonObject.put("crewname", addedCrewName);
            jsonObject.put("crewlevel", addedCrewLevel);
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityCompat.requestPermissions( TempRunningCrewInfoList.this, REQUIRED_PERMISSIONS,
    ...
    private void showDialogForLocationServiceSetting() {
        AlertDialog.Builder builder = new AlertDialog.Builder(TempRunningCrewInfoList.this);
